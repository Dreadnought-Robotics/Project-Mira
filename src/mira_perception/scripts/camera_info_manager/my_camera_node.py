...
camera_info_manager = CameraInfoManager(cname='my_camera_node', url='file:///home/shasankgunturu/.ros/camera_info/camera.yaml', namespace='camera_down/')
...
if __name__ == '__main__':
    ...
    camera_info_publisher = rospy.Publisher('/camera_down/camera_info', CameraInfo, queue_size=10)
    camera_sub = rospy.Subscriber('/camera_down/image_raw/compressed', CompressedImage, callback)
    rospy.spin()
